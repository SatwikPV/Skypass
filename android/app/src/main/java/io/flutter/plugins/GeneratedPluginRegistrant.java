...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.once10301.flutter_upgrade.FlutterUpgradePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_upgrade, com.once10301.flutter_upgrade.FlutterUpgradePlugin", e);
    }
    try {
